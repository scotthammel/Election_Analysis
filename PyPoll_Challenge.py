...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        county_vote_percent = float(vote_count) / float(total_votes) * 100

         # 6d: Print the county results to the terminal.
        county_vote_results = (f"{county_name}:{county_vote_percent:.1f}%({vote_count:,})\n")
